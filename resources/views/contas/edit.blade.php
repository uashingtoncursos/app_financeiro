...
<main class="container m-5">
  <div class="bg-body-tertiary p-5 rounded">
    ...
    <form action="{{route('contas.atualizar',['id' => $registro->id])}}" method="post">
      @csrf
      @method('PUT')
      <div class="mb-3">
        <label for="descricao" class="form-label">Descrição</label>
        <input type="text" class="form-control" value="{{$registro->descricao}}" name="descricao" id="descricao">
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="date" class="form-control" value="{{$registro->data_vencimento}}" name="data_vencimento" id="data_vencimento">
      </div>
      <div class="mb-3">
        <label for="data_pagamento" class="form-label">Data Pagamento</label>
        <input type="date" class="form-control" value="{{$registro->data_pagamento}}" name="data_pagamento" id="data_pagamento">
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="number" class="form-control" value="{{$registro->valor}}" name="valor" id="valor">
      </div>
